    ...
    <form action="{{ route('penjualan.store') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input required type="text" class="form-control" readonly value="<?php echo date('d/M/Y'); ?>"
        ...
        <div class="table-transaction mt-5">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" id="dibayar" name="dibayar"></input>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-sm-8">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="hidden" class="form-control" readonly id="kembalian" name="kembalian"></input>
                </div>
            </div>
